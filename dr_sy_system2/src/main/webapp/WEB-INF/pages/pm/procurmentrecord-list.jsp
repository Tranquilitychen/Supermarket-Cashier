...
<div class="x-body">
    ...
    <xblock>
        ...
        <button class="layui-btn" onclick="x_admin_show('添加员工','${pageContext.request.contextPath}/empl/add',1000,550)"><i class="layui-icon"></i>添加</button>
    ...
    <table class="layui-table layui-form">
        ...
        <c:forEach items="${pageInfo.list}" var="pm">
            <tr>
                ...
                <td class="td-manage">
                    <button class="layui-btn layui-btn layui-btn-xs"  onclick="x_admin_show('修改','${pageContext.request.contextPath}/empl/edit',600,400)" ><i class="layui-icon">&#xe642;</i>修改</button>
