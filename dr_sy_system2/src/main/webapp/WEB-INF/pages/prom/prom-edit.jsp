        ...
        <div class="layui-row layui-col-md6">
            ...
            <div class="layui-row layui-col-md6">
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <input class="layui-input" placeholder="开始时间" name="EJointime" id="joinTime" lay-verify="required">
                    </div>
                </div>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <input class="layui-input" placeholder="结束时间" name="EBirthday" id="birthday" lay-verify="required">
                    </div>
                </div>
